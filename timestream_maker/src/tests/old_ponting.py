...
class utils(object):
    ...
    def __init__(self, coord1, coord2, lst = None, lat = None):
        ...
        self.coord2 = coord2  #Array of coord 2 converted in radians   
        self.lst = lst                    #Local Sideral Time in hours
        self.lat = lat        #Latitude converted in radians
    ...
    def elevationAngle(dec,lat,HA): 
        ...
        return np.pi/2 - self.zenithAngle(dec,lat,HA)
    ...
    def radec2azel(self):
        ...
        el = self.elevationAngle(self.coord2,self.lat,hour_angle)
        az = self.azimuthAngle(self.coord2,self.lat,hour_angle)
